...
enum SyncFeature {
    ...
    static var multiDeviceLegalClause: String {
        isEnabled
        ? "When you turn on iCloud Sync, your inspections — the record, cover photo, signature images, invoice and archive status, report PDFs, thumbnails, and LiDAR floor plans — sync across your own devices through your private iCloud account (Apple's CloudKit). Full-resolution photos, videos, and 3D scan files stay on the device that captured them."
    ...
    static var multiDeviceTermsClause: String {
        isEnabled
        ? "Multi-device note. With iCloud Sync on, your inspections — the record, cover photo, signature images, invoice and archive status, report PDFs, thumbnails, and LiDAR floor plans — sync across your own devices through your private iCloud account; NexGenSpec never receives or stores them. Full-resolution photos, videos, and 3D scan files stay on the device where they were created. With sync off or in Local-Only mode, use the export-to-Files feature to move records intentionally."
