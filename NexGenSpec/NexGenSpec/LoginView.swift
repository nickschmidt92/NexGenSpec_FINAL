...
struct LoginView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("Demo: use **owner** / **supersecret** for admin, or any username & password for user.")
                .font(.caption)
        ...
        .alert("Login Failed", isPresented: $showingError) {
            ...
            Text("Enter a username and password. For demo admin use owner / supersecret.")
        }
...
private struct CreateAccountView: View {
    ...
    private func createAccount() {
        ...
        if authManager.login(username: username, password: password) {
            ...
            errorMessage = "Could not create account. Try a different username and password."
        }
    }
}
