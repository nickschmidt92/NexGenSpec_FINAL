...
struct DashboardView: View {
    ...
    private static let hasInsertedSampleKey = "NexGenSpec.hasInsertedSample"
    ...
    var body: some View {
        NavigationStack {
            ...
            .task {
                if !UserDefaults.standard.bool(forKey: Self.hasInsertedSampleKey), store.metadataList.isEmpty {
                    store.insertSampleInspectionIfNeeded()
                    UserDefaults.standard.set(true, forKey: Self.hasInsertedSampleKey)
                }
            }
