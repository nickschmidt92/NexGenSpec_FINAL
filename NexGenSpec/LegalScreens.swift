        ...
        AppScreenBackground {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Group {
                        Text("What NexGenSpec Collects")
                            .font(.headline)
                        Text("Only your account login (email and an encrypted password, or your Apple ID identifier if using Sign in with Apple), stored in Firebase Authentication. Anonymized crash reports are sent to Firebase Crashlytics if the app crashes. No personal data, no inspection content.")

                        Text("What Stays On Your Device")
                            .font(.headline)
                        Text("All inspection content — defects, photos, signatures, LiDAR scans, notes, client info, agent info, calendar events, invoices, and PDFs — is stored privately on your iPhone or iPad in NexGenSpec's app storage. Other apps cannot read it. NexGenSpec LLC does not receive copies and has no server-side database of inspection data.")

                        Text("iCloud (Optional)")
                            .font(.headline)
                        Text("If you enable iCloud Backup in iOS Settings, your device — including NexGenSpec's app data — is backed up to your personal iCloud account. Apple encrypts and manages that backup. NexGenSpec has no access.")

                        Text("Calendar (Optional)")
                            .font(.headline)
                        Text("If you grant Calendar access, NexGenSpec writes events to a calendar you choose, including the property address, client contact details, agent contact details (if provided), and the NexGenSpec job ID. This is written only to your local calendar and any calendar accounts (iCloud, Google) you have enabled on your device. NexGenSpec does not receive this data.")

                        Text("Sharing")
                            .font(.headline)
                        Text("NexGenSpec LLC does not sell, rent, or share your data. No third-party advertising. No marketing trackers.")

                        Text("Your Control")
                            .font(.headline)
                        Text("Delete the app to remove inspection data from your device. Email contact@nexgenspec.com to delete your login account. Manage your subscription in iOS Settings → Apple ID → Subscriptions.")
                    }
                    .font(.body)
        ...
        Section(header: Text("Legal & Data Safety")) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("Data Safety Summary")
                    .font(.headline)
                Text("""
                NexGenSpec is local-first. Inspection data, photos, signatures, and reports stay on your iPhone or iPad. Only your account login and anonymized crash reports leave the device.
                """)
                    .font(.subheadline)
                    .foregroundColor(.secondary)
