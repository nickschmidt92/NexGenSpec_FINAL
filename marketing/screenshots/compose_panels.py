...
jobs = [
    ...
    ("raw-iphone/roomscan3d.png", "Capture any room in 3D with measured dimensions", "final-iphone/04-room-3d.png", IPHONE),
    ("raw-iphone/dashboard.png", "Every inspection organized in one workspace", "final-iphone/05-dashboard.png", IPHONE),
    ("raw-iphone/annotation.png", "Circle and mark up defects right on the photo", "final-iphone/06-annotation.png", IPHONE),
    ("raw-iphone/paywall.png", "Start free — 3 full inspections, upgrade anytime", "final-iphone/07-paywall.png", IPHONE),
    ("raw-iphone/welcome.png", "The future of inspections is here", "final-iphone/08-welcome.png", IPHONE),
    ...
    ("raw-ipad/roomscan3d.png", "Capture any room in 3D with measured dimensions", "final-ipad/04-room-3d.png", IPAD),
    ("raw-ipad/dashboard.png", "Every inspection organized in one workspace", "final-ipad/05-dashboard.png", IPAD),
]
